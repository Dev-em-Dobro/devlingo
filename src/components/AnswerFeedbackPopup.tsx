...
const AnswerFeedbackPopup = ({ isOpen, type, onContinue, isLoading = false }: AnswerFeedbackPopupProps) => {
          ...
          {isCorrect ? (
            <>
              ...
              <div>
                ...
                <button className="text-sm text-green-600 font-semibold hover:underline mt-1">
                  REPORTAR
                </button>
              </div>
            </>
            ...
            <>
              ...
              <div>
                ...
                <button className="text-sm text-red-600 font-semibold hover:underline mt-1">
                  REPORTAR
                </button>
              </div>
            </>
